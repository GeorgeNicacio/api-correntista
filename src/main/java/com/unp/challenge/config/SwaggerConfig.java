...
public class SwaggerConfig { 
    ...
    public Docket api() { 
        return new Docket(DocumentationType.SWAGGER_2)
          ...
          .select()                                  
          .apis(RequestHandlerSelectors.any()) // .apis(RequestHandlerSelectors.basePackage("com.fabricapp.sgc.resources"))             
    ...
    private ApiInfo apiInfo() {
    	 return new ApiInfo(
    	 "UNP Challeng",
    	 "Esta API é utilizada no UNP Challeng",
    	 "Versão 1.0",
    	 "https://i.ytimg.com/vi/CKgEmWL1YrQ/maxresdefault.jpg",
    	 new Contact("George Nicácio", "https://www.linkedin.com/in/georgenicacio/", "georgenicacio@gmail.com"),
    	 "Permitido uso para desenvolvedores",
    	 "https://i.ytimg.com/vi/CKgEmWL1YrQ/maxresdefault.jpg",
